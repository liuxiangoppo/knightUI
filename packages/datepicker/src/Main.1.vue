<template>
  <span class="k-datepicker">
    ...
    <div class="k-input-wrap" ref="inputReference" :style="{ width: calenderInputWidth }">
      <input type="text" class="k-input__inner" :placeholder="placeholder" @click="clickHandler" :value="chooseDate"/>
      <!-- <div class="k-input__inner" style="line-height: 30px;">
          <k-tag type="info" size="small">2017-09-20</k-tag>
      </div> -->
    </div>
    <!--日历部分-->
    <transition name="fade">
      <div class="k-datepicker-calender" ref="popper" v-show="isShow" :style="{marginLeft: calenderMarginLeft}">
